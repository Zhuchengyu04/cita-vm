...
impl<B: DB> State<B> {
    ...
    pub fn commit(&mut self, block_number: u64) -> Result<(), Error> {
        ...
        let all_sub_commitment = format!("{}{}{}{}", sub_commitments_0,sub_commitments_1,sub_commitments_2,sub_commitments_3);
        let state_commitment = Commitment::new(&all_prover_params, all_sub_commitment.as_ref()).unwrap();
